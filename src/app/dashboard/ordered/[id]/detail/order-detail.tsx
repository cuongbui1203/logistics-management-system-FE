...
export default function OrderDetail({ id }: { id: string }) {
  ...
  const onEndTran =
    order?.order?.endTransactionPoint?.endTransactionPointID === useSession()?.data?.user?.workingPointID;
  return (
    <Container>
      {/* === Thông tin đơn hàng === */}
      <div className="formContainer">
          ...
          <Col xs={12} md={6}>
            <Form.Group>
              ...
              <Form.Control
                ...
                disabled
                value={
                  order?.order?.mainPostage + order?.order?.addedPostage + order?.order?.VATFee + order?.order?.otherFee
                }
              />
            </Form.Group>
          </Col>
        ...
        <Row className="mt-2">
          <Form.Group>
            ...
            <Form.Control type="text" value={orderStatus[order?.order?.goodsStatus]?.now} disabled />
          </Form.Group>
        </Row>
              ...
              <Row>
                <Col xs={12} md={6}>
                  <Form.Group controlId="senderName">
                    ...
                    <Form.Control type="text" value={order?.order?.sender?.fullName} disabled />
                  </Form.Group>
                </Col>
                <Col xs={12} md={6}>
                  <Form.Group controlId="senderPhoneNumber">
                    <Form.Label>Số điện thoại</Form.Label>
                    <Form.Control type="text" defaultValue={order?.order?.sender?.phoneNumber} disabled />
                  </Form.Group>
                </Col>
              </Row>
              <Row className="mt-2">
                <Col>
                  <Form.Group controlId="addressDetail">
                    ...
                    <Form.Control type="text" defaultValue={order?.order?.sender?.address} disabled />
                  </Form.Group>
                </Col>
              </Row>
            </div>
            ...
            <div className="formContainer">
              ...
              <Row>
                <Col xs={12} md={6}>
                  <Form.Group controlId="receiverName">
                    <Form.Label>Họ và tên</Form.Label>
                    <Form.Control type="text" value={order?.order?.receiver?.fullName} disabled />
                  </Form.Group>
                </Col>
                ...
                <Col xs={12} md={6}>
                  <Form.Group controlId="receiverPhoneNumber">
                    <Form.Label>Số điện thoại</Form.Label>
                    <Form.Control type="text" value={order?.order?.receiver?.phoneNumber} disabled />
                  </Form.Group>
                </Col>
              </Row>
              ...
              <Row className="mt-2">
                <Col>
                  <Form.Group controlId="addressDetail">
                    <Form.Label>Địa chỉ</Form.Label>
                    <Form.Control type="text" value={order?.order?.receiver?.address} disabled />
                  </Form.Group>
                </Col>
              </Row>
            </div>
